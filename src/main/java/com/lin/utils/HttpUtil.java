...
public class HttpUtil {
    ...
    * 简单的post请求接口
    * */
    public static HttpResponse doPost(Map<String,String> heads,String url,String jsonParams)throws IOException {
    ...
    * 简单的get请求接口
    * */
    public static HttpResponse doGet(String baseUrl,String jsonParams)throws IOException {
        //将请求参数拼接到url
